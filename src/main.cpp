...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        ufoShader.setVec3("spotLight.diffuse", 1.0f, 1.0f, 1.0f);
        ufoShader.setVec3("spotLight.specular", 1.0f, 1.0f, 1.0f);
        ufoShader.setFloat("spotLight.constant", 1.0f);
        ufoShader.setFloat("spotLight.linear", 0.09);
        ufoShader.setFloat("spotLight.quadratic", 0.032);
